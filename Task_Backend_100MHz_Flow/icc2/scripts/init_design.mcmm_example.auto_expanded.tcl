...
set scenario_constraints($scenario1)    "/home/rbalajis/icc2_workshop_collaterals/raven_wrapper.sdc" ;# for all scenario1 specific constraints

#set scenario2 				"func2" ;# name of scenario2
#set scenario_constraints($scenario2)    "/home//design/picosoc/rtl/picorv32.sdc" ;# for all scenario2 specific constraints
